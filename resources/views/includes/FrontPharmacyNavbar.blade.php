...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('pharmacy/img/leaf.svg') }}">
    <title>pharmacy Dashboard</title> {{ asset('admin/') }}
    <link href="{{ asset('pharmacy/css/bootstrap.css') }}" rel="stylesheet">
    <link href="{{ asset('pharmacy/css/main2.css') }}" rel="stylesheet">
